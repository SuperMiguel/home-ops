...
Also enable **Model Context Protocol Server** (Assist API) so OpenClaw can call `http://home-assistant.home.svc:8123/api/mcp/assist`. Details: `kubernetes/apps/ai/openclaw/SECRETS.md`.
